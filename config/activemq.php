...
return [
    ...
    /*
     * Horizon compatibility settings
     */
    'horizon' => [
        'enabled' => env('ACTIVEMQ_HORIZON_ENABLED', false),

        /*
         * When using Horizon, this determines if workers should be isolated
         * per queue or if they can process multiple queues.
         */
        'isolate_workers' => env('ACTIVEMQ_HORIZON_ISOLATE', true),
    ],
];
